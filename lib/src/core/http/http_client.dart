...
class _HttpClient {
  /// Constructor
  _HttpClient(this._ref) { // ami to jso 
  ...
  String get _getToken {
    if (_ref == null) return ''; // am 
    final authState = _ref.read(authProvider);
    // Check authToken first as primary source, fallback to user.accessToken
    String token = authState.authToken ?? authState.user?.accessToken ?? '';
